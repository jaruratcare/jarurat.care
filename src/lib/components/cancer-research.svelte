  ...
  const articles = [
    {
      ...
      description: 'There are limited published data on recent cancer incidence and mortality trends worldwide...',
      link: '#'
    },
    {
      title: 'Measuring cancer evolution from the genome.',
      description: 'The temporal dynamics of cancer evolution remain elusive, because it is impractical to lon...',
      link: '#'
    },
    {
      title: 'The Role of Telomerase in Breast Cancer’s Response to Therapy.',
      description: 'Currently, breast cancer appears to be the most widespread cancer in the world and the most c...',
      link: '#'
    }
  ];
...
<div class="relative">
  ...
  <div class="flex flex-col items-center py-10">
    <h1 class="text-4xl font-semibold mb-4" style="color: #0D2561;">
      {$t('home.cancer-research.heading')}
    </h1>
    <p class="mb-6" style="color: #0D2561;">
      {$t('home.cancer-research.subheading')}
    </p>
    ...
    <div class="text-lg mb-20" style="color: #04509C; font-size: 1rem;">
      {$t('home.cancer-research.results_for')} <strong>"{searchQuery}"</strong>
    </div>
          ...
          {#each articles as article}
            ...
            >
              <div class="flex flex-col flex-grow">
                <h2 class="font-semibold mb-2 text-[#04509C]" style="text-align: left; word-wrap: break-word;">
                ...
                <p class="text-sm mb-4" style="color: #576171; text-align: left; word-wrap: break-word;">
              ...
              >
                ...
                ></span>
                <span class="relative">{$t('home.cancer-research.read_now')}</span>
              </button>
            </div>
          {/each}
        </div>
