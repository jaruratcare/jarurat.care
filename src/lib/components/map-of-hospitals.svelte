...
<div class="py-16 sm:py-32 px-4 flex flex-col bg-[#D3F2FC]">
	...
	/>
    <div class="search flex flex-row justify-center items-center gap-2"> <!-- Center-aligns form and button -->
		<form
			class="border rounded-full max-w-[28rem] w-full bg-[white] overflow-hidden flex items-center mt-8"
		>
	...
	<div class="flex flex-col md:flex-row justify-center gap-28 max-w-[60rem] mx-auto py-4 sm:my-20 ">
		...
		<div class="relative flex items-center justify-center w-full h-full">
			<!-- Ellipse -->
			<div class="absolute w-[525px] h-[525px] opacity-20 bg-[#0071c3] rounded-full border border-[#85daff] blur-[200px]"></div>
		
			<!-- Map of India -->
			<div class="relative w-[600px] h-[600px] flex-shrink-0 flex items-start justify-end p-4 md:p-0 bg-[#FAF5F3] md:bg-transparent rounded-lg">
