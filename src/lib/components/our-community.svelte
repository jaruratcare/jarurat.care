...
<div class="mx-auto mt-16 w-[90%]">
	<div class="text-primaryBlue text-center font-extrabold text-2xl">Our Community</div>
	<div class="mb-24 text-center font-extrabold text-2xl">Backend Services</div>
