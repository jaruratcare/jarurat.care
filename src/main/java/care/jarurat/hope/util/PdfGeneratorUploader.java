...
public class PdfGeneratorUploader {
    ...
    InputStream fontStream = PdfGeneratorUploader.class.getClassLoader()
    ...
    // Add content using the font
    document.add(new Paragraph("Tailored Nutrition Meal Plan").setFont(font).setBold().setFontSize(16));
    ...
    public static void deletePdfFromUrl(String url) {
        ...
        try {
            ...
            if (url.contains("/o/")) {
                // URL like: https://firebasestorage.googleapis.com/v0/b/<bucket>/o/nutrition_plans%2Fuserid.pdf?...
